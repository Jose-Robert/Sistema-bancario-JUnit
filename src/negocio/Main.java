...
public class Main {
	...
	private static void inicializaSistemaBancario() {
		...
		Cliente cliente01 = new Cliente(1, "José Robert", 23, "joserobert@gmail.com", conta01.getId(), true);
		Cliente cliente02 = new Cliente(2, "Ruth de França", 22, "ruthfranca@gmail.com", conta02.getId(), true);
